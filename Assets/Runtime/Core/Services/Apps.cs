...
namespace Appwrite.Services
{
    public class Apps : Service
    {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.App> Create(string appId, string name, List<string> redirectUris, bool? enabled = null, bool? @internal = null, string? type = null, string? teamId = null)
        {
            var apiPath = "/apps";
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.App> Update(string appId, string name, bool? enabled = null, bool? @internal = null, List<string>? redirectUris = null, string? type = null)
        {
            var apiPath = "/apps/{appId}"
                .Replace("{appId}", appId);
