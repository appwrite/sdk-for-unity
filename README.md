...
```sh
https://github.com/appwrite/sdk-for-unity.git#0.4.0
```

4. Click **Add**.

The `#0.4.0` suffix pins the package to a specific release. Change it to any released tag, or omit `#0.4.0` to track the latest commit on the default branch.
