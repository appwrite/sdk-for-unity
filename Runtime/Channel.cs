...
namespace Appwrite
{
    ...
    public interface IPresence : IActionable
    {
        ResolvedChannel Upsert();
    }
    ...
    internal class ChannelBuilder :
        ...
        IBucket, IFile,
        IFunction, IExecution, IPresence, IActionable
    {
        ...
        private ChannelBuilder Next(string segment, string id = null)
        {
            ...
            if (id != null)
            {
                newSegments.Add(ChannelHelper.Normalize(id));
            }
        ...
        public ResolvedChannel Upsert() => Resolve("upsert");
    ...
    public static class Channel
    {
        ...
        public static IPresence Presence(string id = null) =>
            new ChannelBuilder(new List<string> { "presences", ChannelHelper.Normalize(id) });
        ...
        public static string Presences() => "presences";
    }
}
