...
namespace Appwrite.Services
{
    public class Account : Service
    {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> Get()
        {
            var apiPath = "/account";
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> Create(string userId, string email, string password, string? name = null)
        {
            var apiPath = "/account";
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Oauth2ConsentList> ListConsents(List<string>? queries = null, bool? total = null)
        {
            ...
            static Models.Oauth2ConsentList Convert(Dictionary<string, object> it) =>
                Models.Oauth2ConsentList.From(map: it);
        ...
        public UniTask<Models.Oauth2Consent> GetConsent(string consentId)
        {
            ...
            static Models.Oauth2Consent Convert(Dictionary<string, object> it) =>
                Models.Oauth2Consent.From(map: it);
        ...
        public UniTask<Models.Oauth2ConsentTokenList> ListConsentTokens(string consentId, List<string>? queries = null, bool? total = null)
        {
            ...
            static Models.Oauth2ConsentTokenList Convert(Dictionary<string, object> it) =>
                Models.Oauth2ConsentTokenList.From(map: it);
        ...
        public UniTask<Models.Oauth2ConsentToken> GetConsentToken(string consentId, string tokenId)
        {
            ...
            static Models.Oauth2ConsentToken Convert(Dictionary<string, object> it) =>
                Models.Oauth2ConsentToken.From(map: it);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdateEmail(string email, string password)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.JWT> CreateJWT(long? duration = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdateMFA(bool mfa)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdateName(string name)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdatePassword(string password, string? oldPassword = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdatePhone(string phone, string password)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Preferences> GetPrefs()
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdatePrefs(object prefs)
        {
            var apiPath = "/account/prefs";
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Token> CreateRecovery(string email, string url)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Token> UpdateRecovery(string userId, string secret, string password)
        {
            var apiPath = "/account/recovery";
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.SessionList> ListSessions()
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<object> DeleteSessions()
        {
            var apiPath = "/account/sessions";
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Session> CreateAnonymousSession()
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Session> CreateEmailPasswordSession(string email, string password)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Session> CreateSession(string userId, string secret)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdateStatus()
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Token> CreateMagicURLToken(string userId, string email, string? url = null, bool? phrase = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Token> CreatePhoneToken(string userId, string phone)
        {
